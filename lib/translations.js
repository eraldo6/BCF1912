export const TRANSLATIONS = {
  EN: {
    // Nav
    "nav.back": "Back",
    "nav.sportsbetrieb": "Sports & Teams",
    "nav.impressum": "Imprint & Board",
    "nav.datenschutz": "Privacy Policy",
    "history.breadcrumb": "Club History",
    "sportsbetrieb.breadcrumb": "Sports & Teams",
    "sportsbetrieb.eyebrow": "Work in Progress",
    "sportsbetrieb.headline": "Our Teams",
    "sportsbetrieb.lede": "All teams and sporting activities of BC Frankfurt 1912 e.V. — Pool, Carom and Snooker — will appear here soon.",
    "history.eyebrow": "Work in Progress",
    "history.headline1": "More than a",
    "history.headline2": "Century",
    "history.headline3": "awaits you.",
    "history.lede": "We're gathering documents, photos and stories from over 110 years of club history. The chronicle will appear here soon.",
    "history.timeline.1912": "Founding of BC Frankfurt",
    "history.timeline.1950s": "1950s",
    "history.timeline.1950label": "Rise in the German billiards scene",
    "history.timeline.1980s": "1980s",
    "history.timeline.1980label": "Expansion to include Snooker & Carom",
    "history.timeline.today": "Today",
    "history.timeline.todaylabel": "240+ Members, 3 Disciplines",
    ...
    "error.desc": "An unexpected error occurred. Please try again or return to the home page.",
    "error.retry": "Try again",
    "cal.headline1": "Dates &",
    "cal.headline2": "Events.",
    "cal.lede": "League matches and internal events of BC Frankfurt 1912.",
    "cal.kategorie.Heimspiel": "Home Match",
    "cal.kategorie.Internes Vereinsturnier": "Internal Club Tournament",
    "cal.kategorie.Öffentliches Hausturnier": "Open House Tournament",
    "cal.kategorie.Mitgliederversammlung": "Club Member Meeting",
    "cal.kategorie.Mannschaftstraining": "Team Training",
    "cal.kategorie.Training Anfänger": "Beginner Training",
    "cal.kategorie.Training Fortgeschritten": "Advanced Training",
    "cal.kategorie.Sonstiges": "Other",
    "cal.noEvents": "No events on this day.",
    "cal.allDay": "All day",
    "cal.share": "Share",
    "cal.copyLink": "Copy link",
    "cal.linkCopied": "Link copied!",
    "cal.allMatches": "All matches",
    // Spiele page
    "spiele.breadcrumb": "Matches",
    "spiele.eyebrow": "Schedule & Results",
    "spiele.headline1": "Every Match,",
    "spiele.headline2": "One Place.",
    "spiele.lede": "League fixtures, tournaments, training and internal events — as a chronological list or a monthly calendar.",
    "spiele.view.list": "List",
    "spiele.view.calendar": "Calendar",
    "spiele.filter.all": "All",
    "spiele.filter.pool": "Pool",
    "spiele.filter.snooker": "Snooker",
    "spiele.filter.karambol": "Karambol",
    "spiele.upcoming": "Upcoming",
    "spiele.past": "Past",
    "spiele.empty": "No matches match this filter.",
    "spiele.past.tag": "Past",
    "spiele.matchday": "Matchday",
    "spiele.vs": "vs.",
    "spiele.tba": "Venue TBA",
    "spiele.standings.title": "Standings",
    "spiele.standings.col.rank": "#",
    "spiele.standings.col.team": "Team",
    "spiele.standings.col.played": "Pl.",
    "spiele.standings.col.points": "Pts",
    "spiele.standings.col.diff": "+/−",
    "spiele.standings.empty": "Standings pending",
    "spiele.standings.bcfBadge": "BCF",
    "nav.club": "Club",
    "nav.disciplines": "Disciplines",
    "nav.experience": "Clubhouse & Gallery",
    ...
    "contact.membershipBtn": "All about Membership",

    // Hero
    "hero.stat.jahre": "Years",
    "hero.stat.disziplinen": "Disciplines",
    "hero.stat.mitglieder": "Members",
    "hero.eyebrow": "Est. 1912 — Frankfurt am Main",
    "hero.title": "Frankfurt's home<br />of <em>Billard</em><br /><span class=\"historical\">since 1912.</span>",
    ...
    "club.toSportsbetrieb": "Sports & Our Teams",
    ...
    "membership.regular.feat1": "Your own key — access any time, day or night",
    ...
    "membership.family.tagline": "Spouse and children up to 18 — one membership.",
    "membership.family.feat1": "Same price as regular membership",
    "membership.family.feat2": "Spouse and children up to 18 included",
    ...
    "footer.legal.imprint": "Imprint & Board",
    ...
    "membership.threeWays": "Everything about <em>membership</em>.",
    ...
    "membership.probe.tag": "New members",
    "membership.probe.title": "Trial Membership",
    "membership.probe.desc": "Start at a reduced rate for the first three months, then continue on the regular tariff — no further contract or obligation.",
    "membership.contact.eyebrow": "Trial Training",
    "membership.contact.headline1": "Just drop by?",
    "membership.contact.headline2": "Better to write first.",
    "membership.contact.desc": "BCF is not a public venue — members play with their own key, at any hour. Trial training is by prior arrangement only. Write to us and we'll get back to you within a few days.",
    "membership.contact.label1": "1st Chairman",
    "membership.contact.label2": "Vice President Sport",
    "membership.docs.eyebrow": "Downloads",
    "membership.docs.aufnahme.title": "Membership Application",
    "membership.docs.aufnahme.sub": "Aufnahmeantrag — PDF",
    "membership.docs.satzung.title": "Club Statutes",
    "membership.docs.satzung.sub": "Vereinssatzung — PDF",
    "gallery.letLight": "Wood, felt, light and the people who made this place their own.",
    // Tournaments
    "tournaments.num": "06",
    ...
    "news.num": "01",
    "news.eyebrow": "News Board",
    "news.headline1": "Latest from ",
    "news.headline2": "the Club",
    "news.toCalendar": "Calendar",
    "news.toHistory": "Our Club History",
    "news.toCalendarFull": "To Calendar",
    ...
    "tournaments.sidebarItalic": "Upcoming",
    "tournaments.sidebarTitle": "Tournaments",
    "tournaments.intern": "Internal Club Tournament",
    "tournaments.open": "Open House Tournament",
    "tournaments.registerCuescore": "Register on CueScore",
    "tournaments.resultsCuescore": "Results on CueScore",
    "tournaments.vergangen": "Past",
    "contact.num": "05",
    "contact.visitContact": "Visit & Contact",
    "contact.borsigallee": "Borsigallee 45,<br /><em>Frankfurt</em> am Main.",
    "contact.parking": "Parking on site",
    "contact.transit": "2 min walk from Hessen-Center (U4, U7 & several bus lines)",
    "contact.fiveMinutes": "Two minutes from Hessen-Center — U4, U7 and several bus lines stop right there, parking on site. Drop in any evening from 18:00 — or send a note ahead.",
    "contact.getDirections": "Get Directions",
    "contact.openInMaps": "Open in Maps",
    "contact.membersOnly": "Members Only",
    "contact.privateClub": "This is a <em><span style=\"color:oklch(0.65 0.15 25)\">private</span> club</em>,<br />not a public bar.",
    ...
    "footer.boardLogin": "Board Login",
    "cookie.text": "This website uses",
    "cookie.bold": "no cookies",
    "cookie.suffix": "only technically necessary data.",
    "cookie.link": "Privacy Policy",
  },
  DE: {
    // Nav
    "nav.back": "Zurück",
    "nav.sportsbetrieb": "Sportbetrieb",
    "nav.impressum": "Impressum & Vorstand",
    "nav.datenschutz": "Datenschutz",
    "history.breadcrumb": "Vereinshistorie",
    "sportsbetrieb.breadcrumb": "Sportbetrieb",
    "sportsbetrieb.eyebrow": "In Arbeit",
    "sportsbetrieb.headline": "Unsere Mannschaften",
    "sportsbetrieb.lede": "Hier erscheinen bald alle Mannschaften und der Sportbetrieb des BC Frankfurt 1912 e.V. — Pool, Karambol und Snooker.",
    "history.eyebrow": "In Arbeit",
    "history.headline1": "Mehr als ein",
    "history.headline2": "Jahrhundert",
    "history.headline3": "wartet auf Euch.",
    "history.lede": "Wir sammeln gerade Dokumente, Bilder und Berichte aus über 110 Jahren Vereinsgeschichte. Die Chronik erscheint bald hier.",
    "history.timeline.1912": "Gründung des BC Frankfurt",
    "history.timeline.1950s": "1950er",
    "history.timeline.1950label": "Aufstieg in der deutschen Billardszene",
    "history.timeline.1980s": "1980er",
    "history.timeline.1980label": "Erweiterung um Snooker & Karambol",
    "history.timeline.today": "Heute",
    "history.timeline.todaylabel": "240+ Mitglieder, 3 Disziplinen",
    "notfound.headline": "Seite nicht gefunden.",
    "notfound.desc": "Diese Seite existiert nicht oder wurde verschoben.",
    "error.eyebrow": "Fehler",
    "error.headline": "Etwas ist schiefgelaufen.",
    "error.desc": "Ein unerwarteter Fehler ist aufgetreten. Bitte versuche es erneut oder kehre zur Startseite zurück.",
    "error.retry": "Erneut versuchen",
    "cal.headline1": "Termine &",
    "cal.headline2": "Spielplan.",
    "cal.lede": "Ligaspiele und interne Termine des BC Frankfurt 1912.",
    "cal.kategorie.Heimspiel": "Heimspiel",
    "cal.kategorie.Internes Vereinsturnier": "Internes Vereinsturnier",
    "cal.kategorie.Öffentliches Hausturnier": "Öffentliches Hausturnier",
    "cal.kategorie.Mitgliederversammlung": "Mitgliederversammlung",
    "cal.kategorie.Mannschaftstraining": "Mannschaftstraining",
    "cal.kategorie.Training Anfänger": "Training Anfänger",
    "cal.kategorie.Training Fortgeschritten": "Training Fortgeschritten",
    "cal.kategorie.Sonstiges": "Sonstiges",
    "cal.noEvents": "An diesem Tag keine Veranstaltungen.",
    "cal.allDay": "Ganztägig",
    "cal.share": "Teilen",
    "cal.copyLink": "Link kopieren",
    "cal.linkCopied": "Link kopiert!",
    "cal.allMatches": "Alle Spiele",
    // Spiele-Seite
    "spiele.breadcrumb": "Spiele",
    "spiele.eyebrow": "Spielplan & Ergebnisse",
    "spiele.headline1": "Alle Spiele,",
    "spiele.headline2": "auf einen Blick.",
    "spiele.lede": "Ligaspiele, Turniere, Training und interne Termine — als chronologische Liste oder Monatskalender.",
    "spiele.view.list": "Liste",
    "spiele.view.calendar": "Kalender",
    "spiele.filter.all": "Alle",
    "spiele.filter.pool": "Pool",
    "spiele.filter.snooker": "Snooker",
    "spiele.filter.karambol": "Karambol",
    "spiele.upcoming": "Bevorstehend",
    "spiele.past": "Vergangen",
    "spiele.empty": "Keine Spiele für diesen Filter.",
    "spiele.past.tag": "Vorbei",
    "spiele.matchday": "Spieltag",
    "spiele.vs": "vs.",
    "spiele.tba": "Ort folgt",
    "spiele.standings.title": "Tabelle",
    "spiele.standings.col.rank": "#",
    "spiele.standings.col.team": "Team",
    "spiele.standings.col.played": "Sp.",
    "spiele.standings.col.points": "Pkt.",
    "spiele.standings.col.diff": "+/−",
    "spiele.standings.empty": "Tabelle folgt",
    "spiele.standings.bcfBadge": "BCF",
    "nav.club": "Verein",
    "nav.disciplines": "Disziplinen",
    "nav.experience": "Vereinsheim & Galerie",
    ...
    "contact.membershipBtn": "Alles zur Mitgliedschaft",

    // Hero
    "hero.stat.jahre": "Jahre",
    "hero.stat.disziplinen": "Disziplinen",
    "hero.stat.mitglieder": "Mitglieder",
    "hero.eyebrow": "Gegr. 1912 — Frankfurt am Main",
    "hero.title": "Frankfurts Heimat<br />des <em>Billards</em><br /><span class=\"historical\">seit 1912.</span>",
    ...
    "club.toSportsbetrieb": "Zum Sportbetrieb & unseren Mannschaften",
    "disciplines.karambol.title": "Karambol",
    ...
    "membership.threeWays": "Alles zur <em>Mitgliedschaft</em>.",
    "membership.flatFair": "Eine faire, transparente Beitragsstruktur. Keine Aufnahmegebühr, keine Stundenabrechnung, nur eine Mitgliedschaft und Zugang zum Vereinsheim. Schreib uns, wir melden uns innerhalb weniger Tage bei dir.",
    ...
    "gallery.title": "<em>Atmosphäre</em> in Standbildern.",
    ...
    "footer.legal.imprint": "Impressum & Vorstand",
    ...
    "membership.threeWays": "Alles zur <em>Mitgliedschaft</em>.",
    "membership.flatFair": "Eine faire, transparente Beitragsstruktur. Keine Aufnahmegebühr, keine Stundenabrechnung, nur eine Mitgliedschaft und Zugang zum Vereinsheim. Schreib uns, wir melden uns innerhalb weniger Tage bei dir.",
    "membership.probe.tag": "Neue Mitglieder",
    "membership.probe.title": "Probemitgliedschaft",
    "membership.probe.desc": "Starte die ersten drei Monate zu einem reduzierten Beitrag, danach ganz normal zum regulären Tarif — ohne weiteren Vertrag oder Verpflichtung.",
    "membership.contact.eyebrow": "Probetraining",
    "membership.contact.headline1": "Einfach vorbeikommen?",
    "membership.contact.headline2": "Besser vorher schreiben.",
    "membership.contact.desc": "BCF ist kein öffentlicher Betrieb — unsere Mitglieder spielen mit eigenem Schlüssel, zu jeder Tages- und Nachtzeit. Probetraining ist nur nach vorheriger Absprache möglich. Schreib uns, wir melden uns innerhalb weniger Tage bei dir.",
    "membership.contact.label1": "1. Vorsitzender",
    "membership.contact.label2": "Vizepräsident Sport",
    "membership.docs.eyebrow": "Downloads",
    "membership.docs.aufnahme.title": "Aufnahmeantrag",
    "membership.docs.aufnahme.sub": "Mitgliedsantrag — PDF",
    "membership.docs.satzung.title": "Vereinssatzung",
    "membership.docs.satzung.sub": "Satzung des BCF — PDF",
    "gallery.letLight": "Holz, Tuch, Licht und die Leute, die das hier zu ihrem Ort gemacht haben.",
    // Turniere
    "tournaments.num": "06",
    ...
    "news.num": "01",
    "news.eyebrow": "News Board",
    "news.headline1": "Aktuelles aus ",
    "news.headline2": "dem Verein",
    "news.toCalendar": "Kalender",
    "news.toHistory": "Zu unserer Vereinshistorie",
    "news.toCalendarFull": "Zum Kalender",
    ...
    "tournaments.sidebarItalic": "Kommende",
    "tournaments.sidebarTitle": "Turniere",
    "tournaments.intern": "Internes Vereinsturnier",
    "tournaments.open": "Öffentliches Hausturnier",
    "tournaments.registerCuescore": "Anmelden auf CueScore",
    "tournaments.resultsCuescore": "Ergebnisse auf CueScore",
    "tournaments.vergangen": "Vergangen",
    "contact.num": "05",
    "contact.visitContact": "Besuch & Kontakt",
    "contact.borsigallee": "Borsigallee 45,<br /><em>Frankfurt</em> am Main.",
    "contact.parking": "Parkplätze direkt vor Ort",
    "contact.transit": "2 min Fußweg vom Hessen-Center (U4, U7 & mehrere Buslinien)",
    "contact.fiveMinutes": "Zwei Minuten vom Hessen-Center — U4, U7 und mehrere Buslinien halten direkt dort, Parkplätze vor Ort.",
    "contact.getDirections": "Route planen",
    "contact.openInMaps": "In Maps öffnen",
    "contact.membersOnly": "Nur für Mitglieder",
    "contact.privateClub": "Dies ist ein <em><span style=\"color:oklch(0.65 0.15 25)\">privater</span> Verein</em>,<br />keine öffentliche Bar.",
    ...
    "footer.boardLogin": "Vorstandslogin",
    "cookie.text": "Diese Website verwendet",
    "cookie.bold": "keine Cookies",
    "cookie.suffix": "nur technisch notwendige Daten.",
    "cookie.link": "Datenschutz",
  }
};
